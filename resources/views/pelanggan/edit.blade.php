            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="mt-2">Edit Pelanggan</h5><a href="{{ url('pelanggan') }}"
                            class="btn btn-secondary">
                            Kembali
                        </a>
                    </div>

                    <form method="POST" action="{{ route('pelanggan.update',$data->kode_pelanggan) }}">
                        <div class="card-body">
                            <div class="row">
                                @csrf
                                @method('PATCH')
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input id="name" type="text"
                                            ...
                                            name="nama_pelanggan" value="{{ $data->nama_pelanggan }}" required
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input id="kota" type="text"
                                            ...
                                            value="{{ $data->kota }}" required autocomplete="kota" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input id="no_telepon" type="text"
                                            ...
                                            value="{{ $data->no_telepon }}" required autocomplete="no_telepon" autofocus>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check form-check-inline @error('jenis_pelanggan') is-invalid @enderror" autofocus required>
                                                <label for="jenis_pelanggan">
                                                    <input type="radio" name="jenis_pelanggan" value="tunai" id="jenis_pelanggan" {{$data->jenis_pelanggan == 'tunai'? 'checked' : ''}} required> Tunai
                                                    <input type="radio" name="jenis_pelanggan" value="kredit" id="jenis_pelanggan" {{$data->jenis_pelanggan == 'kredit'? 'checked' : ''}}> Kredit
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input id="plafon" type="text"
                                            ...
                                            value="{{ $data->plafon }}" required autocomplete="plafon" autofocus>
